...
EXPERIMENT_NAME=qwen2_5_vl_7b_geo3k_grpo_api_test
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function=/data2/chenyukun/workspace/EasyR1/examples/reward_function/rubric_api.py:compute_score \
